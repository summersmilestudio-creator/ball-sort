...
/// Localized notification copy. Notifications are scheduled outside the widget
/// tree (no BuildContext), so we resolve the text from the device locale
/// against an inline map of the supported languages, defaulting to Romanian.
class NotificationStrings {
  NotificationStrings._();

  static const String _defaultTitle = 'Ball Sort Puzzle';

  static const Map<String, String> _body = {
    'ro': 'O partidă rapidă de sortare bile? 🎯',
    'en': 'Up for a quick ball-sorting round? 🎯',
    'es': '¿Una partidita rápida ordenando bolas? 🎯',
    'pt': 'Que tal uma partida rápida organizando bolas? 🎯',
    'fr': 'Une petite partie de tri de billes ? 🎯',
    'de': 'Lust auf eine schnelle Runde Kugelsortieren? 🎯',
    'it': 'Una partita veloce a ordinare palline? 🎯',
    'ru': 'Быстрая партия по сортировке шариков? 🎯',
    'ja': 'サクッとボール仕分けで一勝負しませんか？🎯',
    'ko': '공 정리 한 판 어때요? 🎯',
    'zh': '来局快速分球小游戏？🎯',
  };
  ...
  static String title() => _defaultTitle;

  static String body() => _body[_langCode()] ?? _body['ro']!;
}
