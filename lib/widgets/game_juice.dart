...
/// soft out-of-focus "bokeh" orbs floating upward. Gives casual games an
/// expensive, modern look with almost no cost. Wrap your screen body with it.
...
class _PremiumBackgroundState extends State<PremiumBackground>
  ...
  // Fixed orb seeds: x (0..1), base radius factor, speed, phase. Deterministic
  // so the orbs never flicker between frames.
  static const _orbs = [
    [0.18, 0.34, 0.7, 0.0],
    [0.78, 0.46, 0.5, 0.3],
    [0.50, 0.28, 0.9, 0.6],
...
/// One-shot sparkle/star burst at a point — use when a tube/bottle is fully
/// sorted. Self-removing: pass it through [BurstOverlay.show].
class BurstOverlay {
